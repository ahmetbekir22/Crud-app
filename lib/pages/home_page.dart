...
class _HomePageState extends State<HomePage> {
  ...
  void _filterUsers(String query) {
    final filtered = _users.where((user) => user.name!.toLowerCase().contains(query.toLowerCase())).toList();
    setState(() {
                  ...
                  child: ListTile(
                    title: Column(
                      ...
                      children: [
                        ...
                        if (age != null) Text('Age: $age', style: TextStyle(color: Colors.cyan)),
                        if (horoscope != null) Text('Horoscope: $horoscope', style: TextStyle(color: Colors.cyan)),
                      ],
                    ),
